#!/usr/bin/python3
""" Module that tests Rectangle class """
import unittest
...
class TestRectangleMethods(unittest.TestCase):
    ...
    def test_is_Base_instance(self):
        """ Test Rectangle of Base instance """
        new = Rectangle(1, 1)
    ...
    def test_access_private_attrs(self):
        """ attempt to access to a private attribute """
        new = Rectangle(1, 1)
    ...
    def test_valide_attrs(self):
        """ attempt to pass a string value """
        with self.assertRaises(TypeError):
    ...
    def test_value_attrs(self):
        """ atttempt to pass invalid values """
        with self.assertRaises(ValueError):
            new = Rectangle(0, 1)

    def test_value_attrs_1(self):
        """ attempt to pass invalid values """
        with self.assertRaises(ValueError):
            new = Rectangle(1, 0)
    ...
    def test_area(self):
        """ Checking the return value of method area"""
        new = Rectangle(4, 5)
    ...
    def test_dict_to_json(self):
        """ Test Dictionary lead to JSON string """
        r1 = Rectangle(2, 2)
