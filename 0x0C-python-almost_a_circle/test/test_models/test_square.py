#!/usr/bin/python3
""" Module for the test Square class """
import unittest
...
class TestSquareMethods(unittest.TestCase):
    ...
    def test_access_private_attrs_4(self):
        """ Ties to access to a private attribute """
        new = Square(1)
        with self.assertRaises(AttributeError):
            new.__y

    def test_valide_attrs(self):
        """ Tries to pass a string value """
        with self.assertRaises(TypeError):
            new = Square("2", 2, 2, 2)
    ...
    def test_area(self):
        """ Checks return value of area method """
        new = Square(4)
        self.assertEqual(new.area(), 16)

    def test_load_from_file(self):
        """ Test load for JSON file """
    ...
    def test_str(self):
        """ Test __str__ that returns value """
        r1 = Square(4, 2, 2)
        res = "[Square] (1) 2/2 - 4\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(r1)
    ...
    def test_str_2(self):
        """ Test __str__that returns value """
        r1 = Square(3, 2, 5, 3)
        res = "[Square] (3) 2/5 - 3\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(r1)
    ...
    def test_dict_to_json(self):
        """ Test Dictionary leads to JSON string """
        s1 = Square(2)
    ...
    def test_value_square(self):
        """ Test value pased to the Square """
        with self.assertRaises(ValueError):
            s1 = Square(-1)
